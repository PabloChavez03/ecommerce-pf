...
export default function CreationProduct() {
  ...
  const handleClickDelete = (event) => {
    ...
    setData({
      ...data,
      [event.target.name]: data[event.target.name].filter(
      ...
      <form>
        ...
        <div>
          ...
          <select name={"colors"} onChange={(e) => handleChangeSelect(e)}>
            ...
            {colores.length
              ? colores.map((color) => (
                  <option name={"colors"} value={color}>
                    {color}
                  </option>
                ))
              : null}
        ...
        <div>
          ...
          <select
            name={"ispromotion"}
            onChange={(e) => handleSelectPromotion(e)}
          >
            <option value={"Seleccionar"}>Seleccionar</option>
            <option value={true} name={"ispromotion"}>
              Si
            </option>
            <option value={false} name={"ispromotion"}>
              No
            </option>
          </select>
        </div>
        {data.ispromotion === true ? (
          <div>
            ...
            <div>
              ...
              <input
                type="text"
                placeholder="Mensaje de promoción"
                name={"promotion_msg"}
                value={data.promotion_msg}
                onChange={(e) => handleChangeInput(e)}
              />
            </div>
          </div>
          ...
          <select name={"categories"} onChange={(e) => handleChangeSelect(e)}>
            ...
            {categorias.length
              ? categorias.map((category) => (
                  <option name={"categories"} value={category}>
                    {category}
                  </option>
                ))
              : null}
