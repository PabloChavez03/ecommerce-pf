...
import commentsIcon from "./images/comentario.png";
	...
	return (
		<div className={style.cardContainer}>
			...
			<div>
				...
				<NavLink to={`/admin/reviews/${id}`} style={{ textDecoration: "none" }}>
				<img className={style.btn} src={commentsIcon} alt='eliminar' />
				</NavLink>
