...
const AdminCreate = () => {
	...
	const handleSubmit = (e) => {
		...
		dispatch(createNewUser(newAdmin));
		setNewAdmin({
			user_name: "",
			legajo_user: "",
			rol: "admin",
						...
						{activeCreate ? (
							<div className={style.formCreateActive}>
								...
								<div className={style.formInputContainer}>
									...
									<input
										className={
											error.user_password !== "good" && correct
												? style.error
												: style.formInput
										}
										type="password"
									...
									/>
									{error.user_password !== "good" && correct ? (
										<p className={style.errMsj}>{error.user_password}</p>
									) : (
										<p> </p>
									)}
								</div>
								<div className={style.formInputContainer}>
									...
									<input
										className={
											error.confirm_user_password !== "good" && correct
												? style.error
												: style.formInput
										}
								...
								<button className={style.formButtonCreateActive}>CREAR</button>
								<button
							...
							<div className={style.formCreateNotActive}>
								...
								<div className={style.formInputContainer}>
									...
									/>
									{error.user_name !== "good" && correct ? (
										<p className={style.errMsj}>{error.user_name}</p>
									) : (
										<p> </p>
									)}
								</div>
								<div className={style.formInputContainer}>
									...
									<input
										className={
											error.legajo_user !== "good" && correct
												? style.error
												: style.formInput
										}
										type="number"
									...
									/>
									{error.legajo_user !== "good" && correct ? (
										<p className={style.errMsj}>{error.legajo_user}</p>
									) : (
										<p> </p>
									)}
								</div>
